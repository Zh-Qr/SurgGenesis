...
source "${ROOT_DIR}/configs/stage3_cholecTrack20.env"
...
CMD=(
  "${ROOT_DIR}/src/finetune/train_vace_dit_track20_stage3.py"
  --stage stage3
  ...
  --frame_embed_dirname "${FRAME_EMBED_DIRNAME}"
  --prompt_pattern "${PROMPT_PATTERN:-*_prompts.json}"
  --prompt_match "${PROMPT_MATCH:-exact}"
